...
class GaussianDiffusion(nn.Module):
    ...
    def sample(
        ...
        noisy_fine_img_02 = torch.randn_like(coarse_img_01)
        sample_fn = (
    ...
    def forward(self, coarse_img_01, coarse_img_02, fine_img_01, fine_img_02):
        ...
        noisy_fine_img_02_t = self.diffusion_process(x_0=fine_img_02, t=t, noise=noise)

        denoiser_output = self.denoiser(
            coarse_img_01, coarse_img_02, fine_img_01, noisy_fine_img_02_t, t
        )
