...
from src.model.stfdiffusion.model_3 import Unet, GaussianDiffusion
...
checkpoint_path = 'results/stfdiff/syy_setting-9/model_2/CIA/Unet_32~Adam_1e-4/checkpoints/model_epoch_199.pth'
