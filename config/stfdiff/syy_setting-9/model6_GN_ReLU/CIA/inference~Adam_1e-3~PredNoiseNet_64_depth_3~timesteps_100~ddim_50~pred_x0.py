...
from src.model.stfdiff.model6_GN_ReLU import PredNoiseNet, GaussianDiffusion
...
checkpoint_path = "results/stfdiff/syy_setting-9/model6_GN_ReLU/CIA/Adam_1e-3~PredNoiseNet_64_depth_3~timesteps_100~ddim_50~pred_x0/checkpoints/model_epoch_299.pth"
