...
test_dataset = ConcatDataset(
    [
        dataset_cls_func(
            ...
            extend_data_root='results/spstfm/syy_setting_8/sample_num-2000~atom_num-512~sparsity-3/training_dictionary_pair/dictionary_sparisty/CIA/',
            transform_func_list=test_transform_list,
        ),
        dataset_cls_func(
            dataset_name='LGC',
            data_root='data/spatio_temporal_fusion/LGC/private_data/syy_setting-8/test/patch',
            extend_data_root='results/spstfm/syy_setting_8/sample_num-2000~atom_num-512~sparsity-3/training_dictionary_pair/dictionary_sparisty/LGC/',
            transform_func_list=test_transform_list,
        ),
    ]
)
