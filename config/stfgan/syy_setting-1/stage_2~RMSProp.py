...
val_dataset = ConcatDataset(
    [
        dataset_cls_func(
            data_root='data/spatio_temporal_fusion/CIA/private_data/syy_setting-1-patch/val',
            transform_func_list=val_transforms_list,
        ),
        dataset_cls_func(
            data_root='data/spatio_temporal_fusion/LGC/private_data/syy_setting-1-patch/val',
            transform_func_list=val_transforms_list,
        ),
    ]
)
...
test_dataset = ConcatDataset(
    [
        dataset_cls_func(
            data_root='data/spatio_temporal_fusion/CIA/private_data/syy_setting-1-patch/test',
            transform_func_list=test_transforms_list,
        ),
        dataset_cls_func(
            data_root='data/spatio_temporal_fusion/LGC/private_data/syy_setting-1-patch/test',
            transform_func_list=test_transforms_list,
        ),
    ]
)
