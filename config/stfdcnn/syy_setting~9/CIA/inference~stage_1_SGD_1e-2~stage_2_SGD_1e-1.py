...
checkpoint_stage_1_path = (
    'results/stfdcnn/syy_setting~9/CIA/stage_1_SGD_1e-2/checkpoints/model_epoch_999.pth'
)
checkpoint_stage_2_path = (
    'results/stfdcnn/syy_setting~9/CIA/stage_2_SGD_1e-1/checkpoints/model_epoch_999.pth'
)
